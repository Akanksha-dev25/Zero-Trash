...
import { StandaloneSearchBox, useOsmApiLoader } from '@/components/osm-search-box'
...
export default function ReportPage() {
  ...
  const { isLoaded } = useOsmApiLoader();
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      // Remove any potential backticks or "json" prefix from the response
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <StandaloneSearchBox onPlaceChanged={onPlaceChanged} />
          </div>
          <div>
